...
echo "DARKNET_"`/sbin/ifconfig $INTERFACE | grep 'inet ' | awk '{print $2}' | head -n 1 | tr '.' '_'` > /etc/hostname 
...
ICAgaWYgW2lkLm9yaWdfcF0gPT0gIjQyMjI0IiBvciBbaWQucmVzcF9wXSA9PSAiNDIyMjQiIHsK
ICAgICAgZHJvcCB7IH0KICAgIH0KICAgIGlmIFtpZC5vcmlnX3BdID09ICI1NjcyIiBvciBbaWQu
cmVzcF9wXSA9PSAiNTY3MiIgewogICAgICBkcm9wIHsgfQogICAgfQogIH0gIyMjI2VuZCBicm9f
Y29ubiMjIyMKCg==' | base64 -d > /etc/logstash/conf.d/logstash.conf
